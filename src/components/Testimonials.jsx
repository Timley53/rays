...
<div className="marquee_content overflow-x-hidden w-full">
        ...
        <div className="testimonial_cards flex flex-nowrap items-center justify-start md:w-[90%] w-full mx-auto h-full md:p-4 ">
            ...
            <TestimonialCard item={{name: 'Sam W',  image: 'https://s3-alpha-sig.figma.com/img/151c/a36e/0a3d3fc0d34cf0d02f566ad377813e78?Expires=1745798400&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Wl51MRjXONYY07h0AN1D~vV-Uu9dnC37~~nX9DrbjU0DJwi6eYVlgcjj3RhpDXrJy~UvRfqrf00ThRcASaQExCYil69MunObiEW1HQBK4ve~OGSqOzKj0OeTClyHAa4z2IZvBPuulW-fcq95uCWkE1KgcKzdOr3qQlRSbU6-IsSfZh4NgJcZrVthY2rbzL-zaGCJi13osJGdCCoUmNRhtRqzaNYTuHXdQpy8cvH1lvM~aGi9~zFJvPLeAWI6QiIJz~Be7gqRXfECZqJvYeoB7igkptl~kE8eeD8rP517k88JGBmwYgM7XaTP3mzJjH28vViTr4U0Jxnoek19B9MUdw__', testimonial: 'Beautiful interiors and a relaxing ambiance. Whether youre dining in or just having coffee, the space feels like a little escape.'}}/>
