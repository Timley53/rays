  ...
  return (
    ...
    <div className="hero h-screen w-screen flex flex-col justify-center items-center  " id='Home'>
      ...
      <div className="hero_text text-white  mb-4 z-10 w-full text-center pt-10 ">
          <p className='w-[95%] md:w-[98%] mx-auto my-5 md:text-6xl text-4xl'>Savor Every Bite. Experience Authentic Flavours. </p>
          <p className='md:w-[50%] w-[60%] max-w-[450px] md:text-xl mx-auto text-center text-base mt-14 md:mt-1'>Indulge in handcrafted dishes made with fresh, locally sourced ingredients. Dine in or order online.</p>
